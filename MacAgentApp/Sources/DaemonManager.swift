...
final class DaemonManager {
    ...
    var projectRoot: String {
        if let fromPlist = Bundle.main.object(forInfoDictionaryKey: "MacAgentRoot") as? String,
           !fromPlist.contains("$("),
           FileManager.default.fileExists(atPath: fromPlist + "/main.py") {
            return fromPlist
        }
        // Dev: MacAgentApp/Sources → repo root is ../..
        let candidates = [
